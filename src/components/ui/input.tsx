...
function Input({ className, invalid, onFocus, onBlur, ...props }: InputProps) {
  return (
    <TextInput
      ...
      onBlur={onBlur}
      className={cn(
        'border-brand bg-background text-foreground flex h-10 w-full min-w-0 flex-row items-center rounded-md border px-3 py-1 text-base leading-5 shadow-sm shadow-black/5 sm:h-9',
